  ...
  return (
    <section className="expertiseContainer">
      <div className="flex flex-col justify-center items-center">
        <p className="header text-center text-7xl mb-16 font-extrabold">
          My Expertise
        </p>
        <div className="expertiseSubContainer flex justify-center items-center flex-wrap">
          <div className="box border-2 border-solid border-white w-96 p-10 pl-5 pr-5 overflow-hidden">
          ...
          {/* 1 */}
          <div className="box border-2 border-solid border-white w-96 p-10 pl-6 pr-5 overflow-hidden">
